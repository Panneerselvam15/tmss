...
namespace TrainingManagementSystem.Controllers
{
    ...
    public class EvaluationsController : ControllerBase
    {
        ...
        {
            if (id != evaluation.SessionRating)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Evaluation>> PostEvaluation(Evaluation evaluation)
        {
            ...
            return CreatedAtAction("GetEvaluation", new { id = evaluation.SessionRating }, evaluation);
        }
        ...
        {
            return _context.Evaluations.Any(e => e.SessionRating == id);
        }
    }
}
